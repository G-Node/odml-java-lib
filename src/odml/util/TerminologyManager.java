...
public class TerminologyManager {
	...
	private static final String TERMINOLOGIES_FILE = System.getProperty("user.home")
			+ System.getProperty("file.separator") + "odml" + System.getProperty("file.separator")
			+ "terminologies.properties";
	private static final String REDIRECTIONS = System.getProperty("user.home") + System.getProperty("file.separator")
			+ "odml" + System.getProperty("file.separator") + "redirections.properties";
	...
	private TerminologyManager() {
		try {
			...
			if (!userFile.exists()) {
				File dir = new File(System.getProperty("user.home") + System.getProperty("file.separator") + "odml");
				if (!dir.exists())
					dir.mkdir();
	...
	public Section loadTerminology(URL repository, String sectionType) {
		// check Hash
		Section s = null;
		String key = repository.getProtocol() + "://" + repository.getAuthority() + repository.getPath() + "#"
				+ sectionType;
